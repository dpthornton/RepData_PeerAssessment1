...
Optionally set the working directory, needs to contain the activity.zip

```{r}

setwd("/Users/danielthornton/workspace/Data Science/Reproducible_Research/week_2/RepData_PeerAssessment1")
```
...
```{r}
# Histrogram of the steps per day
